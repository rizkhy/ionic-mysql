...
export class TranskipSiswaPage {
  ...
  ionViewWillEnter()
   ...
   getData(){
    ...
    return new Promise((resolve, reject)=>{
      ...
      this.http.post('http://localhost/siakad_phpV3/api/transkip-siswa.php', data, {headers: headers})
      .map(res => res.json())
      .subscribe(data =>{
        this.items = data;        
      })
  ...
  getSemester(){
    ...
    return new Promise((resolve, reject)=>{
      ...
      console.log(a)
      this.http.post('http://localhost/siakad_phpV3/api/transkip_semester.php', a, {headers: headers})
      .map(res => res.json())
      .subscribe(data =>{
        this.items = data;        
      })
